...
function SignUp() {
  ...
  const [message, setMessage] = useState("")
    ...
    const submit = async (e) => {
      ...
      filterUserInput(6, 60, password, /A-zÀ-ÿ/g)
      filterUserInput(3, 60, username, /A-zÀ-ÿ/g)

      if (validInput && validEmail && validPhone || validInput && email === "" && validPhone || validInput && phone === "" && validEmail) {
        e.preventDefault()
